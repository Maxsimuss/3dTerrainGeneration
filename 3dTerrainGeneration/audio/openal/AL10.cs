...
namespace OpenAL
{
    ...
    {
        public const string nativeLibName = "Resources/libs/soft_oal.dll";
        ...
        [DllImport(AL10.nativeLibName, EntryPoint = "alGetString", CallingConvention = CallingConvention.Cdecl)]
