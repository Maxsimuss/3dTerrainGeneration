...
namespace _3dTerrainGeneration
{
    ...
    public class Camera
    {
        ...
        {
            return Matrix4.CreatePerspectiveFieldOfView(_fov, AspectRatio, .05f, World.renderDist * 2);
        }

        public Matrix4 GetOrthoMatrix()
        {
            return Matrix4.CreateOrthographicOffCenter(-10.0f, 10.0f, -10.0f, 10.0f, 1f, float.MaxValue);
        }
